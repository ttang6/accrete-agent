...
用法（项目根）：
    ...
    .venv/Scripts/python.exe src/nanoagent/mcp/client.py                  # 发现配置/默认里所有 server
    .venv/Scripts/python.exe src/nanoagent/mcp/client.py --config my.json
    .venv/Scripts/python.exe src/nanoagent/mcp/client.py --read-resource <uri>
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="nanoagent MCP client（FastMCP，主动发现）")
    parser.add_argument(
        "--config",
        type=Path,
